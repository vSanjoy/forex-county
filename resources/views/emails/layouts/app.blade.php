    	...
    	<tbody>
      		<tr>
        		<td align="center" valign="middle" bgcolor="#fff" height="100" style="padding:15px; margin:0; line-height:0px; border:1px solid #0a0b0d; height: 100px;">
          			<a href="{{ getBaseUrl() }}" target="_blank" style="display:block;"><img src="{{asset('images/logo.png')}}" alt="" width="128" height="74" style="border:0; width: 128px; height: 74px; display: block;" /></a>
        		</td>
      		</tr>
      		<tr>
