            ...
            <div class="col-md-12">
                <div class="card mb-4">
					...
					{{ Form::open([
						'method'=> 'POST',
						'class' => '',
						'route' => [$routePrefix.'.cms.edit', customEncryptionDecryption($cms->id)],
						'name'  => 'updateCmsForm',
						'id'    => 'updateCmsForm',
						'files' => true,
						'novalidate' => true]) }}
						...
						<div class="row g-3">
                            <div class="col-md-6">
								...
								{{ Form::text('page_name', $details->page_name ?? null, [
																'id' => 'page_name',
																'class' => 'form-control',
							...
							<div class="col-md-6">
								...
								{{ Form::text('short_title', $details->short_title ?? null, [
																	'id' => 'short_title',
																	'class' => 'form-control',
							...
							<div class="col-md-6">
								...
								{{ Form::text('short_description', $details->short_description ?? null, [
																		'id' => 'description2',
																		'class' => 'form-control',
							...
							<div class="col-md-12">
								...
								{{ Form::textarea('description', $details->description ?? null, [
																	'id' => 'description',
																	'class' => 'form-control',
							...
							<div class="col-md-6">
								...
								{{ Form::text('meta_title', $details->meta_title ?? null, [
																	'id' => 'meta_title',
																	'class' => 'form-control',
							...
							<div class="col-md-6">
								...
								{{ Form::text('meta_keywords', $details->meta_keywords ?? null, [
																	'id' => 'meta_keywords',
																	'class' => 'form-control',
							...
							<div class="col-md-12">
								...
								{{ Form::textarea('meta_description', $details->meta_description ?? null, [
																			'id' => 'meta_description',
																			'class' => 'form-control',
						...
						<div class="row g-3">
                            <div class="col-md-6 d-flex align-items-start align-items-sm-center gap-3">
								...
								if ($details->featured_image != null && file_exists(public_path('images/uploads/'.$pageRoute.'/'.$details->featured_image))) :
                                    $image = asset("images/uploads/".$pageRoute."/".$details->featured_image);
                                endif;
								@endphp
