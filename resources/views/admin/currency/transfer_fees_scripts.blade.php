...
$(document).ready(function() {
    ...
    @if (Route::currentRouteName() == $routePrefix.'.'.$pageRoute.'.transfer-fees.transfer-fees-list')
	// Get list page data
	var getListDataUrl = "{{route($routePrefix.'.'.$pageRoute.'.transfer-fees.ajax-list-request', customEncryptionDecryption($currency->id))}}";
