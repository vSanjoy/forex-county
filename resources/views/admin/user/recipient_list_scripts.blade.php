...
$(document).ready(function() {
    ...
    @if (Route::currentRouteName() == $routePrefix.'.'.$pageRoute.'.recipient.recipient-list')
	// Get list page data
	var getListDataUrl = "{{ route($routePrefix.'.'.$pageRoute.'.recipient.ajax-list-request', customEncryptionDecryption($user->id))}}";
